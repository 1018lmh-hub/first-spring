...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter" style="padding:5% 10%;">
            <h2>게시판</h2>
            <br>
            <!-- 뭐더라, request, session 스코프 순으로 찾음-->
                ...
                <tbody>
                	...
                	<script>
                		function toDetail(boardNo){
                			location.href = `/spring/boards/\${boardNo}`;
                		}
                	</script>
            ...
            <div id="pagingArea">
                <ul class="pagination">
                    <li class="page-item disabled"><a class="page-link" href="/spring/boards?page=${ num }">이전</a></li>
                    ...
                    <li class="page-item"><a class="page-link" href="/spring/boards?page=${ num }">다음</a></li>
                </ul>
            </div>
